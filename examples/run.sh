...
if [[ $scenario == 1 ]]; then
    ...
    #              file
    python3 ../witch.py -y -i ${all_unaligned_path} -d scenarioA_output \
        -o ${outname}
elif [[ $scenario == 2 ]]; then
    # Scenario B - unaligned sequences only; using bit scores;
    #              using 10 HMMs to align a sequence
    python3 ../witch.py -i ${all_unaligned_path} -d scenarioB_output \
        -o ${outname} -w 0 -k 10
    ...
    python3 ../witch.py --num-cpus -1 -b ${backbone_aln_path} \
