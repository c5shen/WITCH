...
# 1.22.2022 - Copied over and modified to accomodate GCMM from SEPP
# by Chengze Shen
...
#        node.maxheight = n1
    ...
    def __get_breaking_edge__(tre, edge_type):
        ...
        if edge_type == 'midpoint':
            ...
            Configs.warning(("Invalid decomposition type! Please use either "
    ...
    Configs.debug("Starting brlen decomposition ...")
    __ini_record__()
