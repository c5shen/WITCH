...
# 1.22.2022 - This file is copied and slightly modified from SEPP to GCMM
...
for l2 in sys.stdin.readlines():
        ...
        # Configs.info("Use this code to map back internal nodes::\n %s" %
        #  str(self._revscript))
